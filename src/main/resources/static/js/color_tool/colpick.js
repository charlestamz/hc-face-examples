	...
	var colpick = function () {
		var
			...
			clickSubmit = function (ev) {
				...
				//add by GaryXu-2017-09-08--start
				var colorVal = $(cal).data('colpick').hsl ? hslToHex(col) : hsbToHex(col);
				$("#tagColorButton").css('backgroundColor',"#"+colorVal);
				$("#tagColorInput").val("#"+colorVal);
				//add by GaryXu-2017-09-08--start
